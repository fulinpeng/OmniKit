...
* 基于 SuperTrend & ssl-策略描述-0.md
* 修改了superTrend 的下轨为lowerBand，上轨为upperBand
* 去掉了原来的移动止损自适应止盈，改为固定止盈+指标止盈
* dema入场改为ssl + qqeMod 入场
* 开单会更多
* 趋势用双SSL确定
* qqeMod回调入场
* SuperTrend + Fib 止盈
* 还别说，开单斜率关系非常大啊
* trend上下轨止损止盈，避免频繁止损问题
---
...
**条件组合**：`section3Up = (section3Up1 or section3Up2)`
...
**条件组合**：`section3Down = (section3Down1 or section3Down2)`
